...
│   │   ├── tasks/                # Workflow execution tasks
...
│   │   ├── bmad-analysis/       # Analysis agent
│   │   ├── bmad-research/       # Research agent
│   │   ├── bmad-review/         # Review agent
│   │   └── bmad-planning/       # Planning agent
...
│   └── [generated files]         # Additional docs generated by this workflow
│
├── apps/                           # 🎯 APPLICATION LAYER
│   └── web/                      # Part: web (Next.js full-stack app)
│       ├── src/
...
**Type Safety:**
- End-to-end types from DB → API → Frontend
