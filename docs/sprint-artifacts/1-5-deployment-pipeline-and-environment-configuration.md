...
│       └── 1-5-research/
│           ├── phase-1-ci-pipeline.md          # Research findings Phase 1
│           ├── phase-2-docker.md               # Research findings Phase 2
│           ├── phase-3-preview-deployments.md  # Research findings Phase 3
│           ├── phase-4-production.md           # Research findings Phase 4
│           └── phase-5-dependencies.md         # Research findings Phase 5
├── apps/
│   └── web/
